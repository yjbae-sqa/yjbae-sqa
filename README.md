...
## 🧩 Quality Engineering
- CI/CD 파이프라인 내 자동화 테스트 연계 및 실행
- Release 안정성 검증을 위한 Regression 테스트 구조 개선
- 배포 리스크 기반 품질 검증 및 Quality Gate 운영
- Dev 협업 기반 테스트 프로세스 개선
- Docker 기반 환경에서 자동화 테스트 실행
- 서비스 구조 기반 API 및 서비스 흐름 테스트
- 초기 조직에서 QA 프로세스 구축 및 운영
...
### Test Automation
- Selenium / Appium 기반 UI 자동화
- TestNG 기반 테스트 실행
- Newman 기반 API 테스트 실행
- Allure 기반 테스트 리포트
